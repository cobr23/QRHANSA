...
router.get('/', async (req, res) => {
    ...
    async function HANSAMAL_MD_PAIR_CODE() {
        const {
            state,
            saveCreds
    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*DONT SHARETIS CODE WITH ANYONE!!THIS ID USE CREATE HANSAMAL-MD.*\n\n ◦ *Github:* https://github.com/cobrs11/HANSAMAL-MD`; 
                        await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
title: "HANSAMAL-MD",
thumbnailUrl: "https://telegra.ph/file/44826e95f6e863548e408.jpg",
...
{quoted:ddd })
   ...
   return await HANSAMAL_MD_PAIR_CODE();
});/*
setInterval(() => {
